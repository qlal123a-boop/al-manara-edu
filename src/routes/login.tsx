      ...
      <div className="mx-auto flex min-h-[60vh] max-w-md items-center px-5">
        <div className="w-full rounded-3xl border border-gold/40 bg-card p-8 shadow-luxury text-center">
          ...
          <div className="mt-6 flex flex-col gap-2">
            ...
            <Link to="/pricing" className="rounded-xl bg-gradient-gold py-3 text-sm font-bold shadow-gold transition-smooth hover:scale-[1.02]" style={{ color: "var(--royal-deep)" }}>استكشاف خطط الاشتراك</Link>
